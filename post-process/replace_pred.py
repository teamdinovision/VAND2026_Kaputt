...
prediction.to_csv("prediction_dinovision.csv", index=False)
print(f"Done. Replaced {prediction['capture_id'].isin(small_ids).sum()} rows. Output: prediction_dinovision.csv")
